...
for (let i = 0; i < picArray.length; i++) {
  ...
  art.addEventListener('click', function() {
    document.querySelector("img").setAttribute('src', picArray[i]['image']['large'])
    document.querySelector("img").setAttribute('alt', picArray[i]['title'])
  ...
  image.setAttribute('src', picArray[i]['image']['medium'])
  image.setAttribute('alt', picArray[i]['title'])
  let caption = document.createElement('figcaption')
  caption.textContent = picArray[i]['title']
  ...
  art.appendChild(p)
  document.querySelector("#pictures").appendChild(art)
}